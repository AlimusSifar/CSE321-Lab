...
class QuestionBuffer {
    ...
    public synchronized String readQuestionFromReg() throws InterruptedException {
         ...
         * readQuestionFromReg()].
         * 2. If the pointer is at -1, it means there is no item in the list. So,
         * suspend the StudentThread [using wait()].
    ...
    public synchronized void writeQuestionToReg(String value) {
         ...
         * 4. If the pointer is at 0, it indicates first item in the list. So, wakeup
         * StudentThread [using notifyAll()].
         */
        registers.add(value);
...
public class LabTask {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Buffer pointer value: " + questionBuffer.pointer);
    }
}